...
1.3. State your prediction clearly. Example: "Predicted Domain: tech_venture."
...
3.1. Using your analysis and the predicted domain, select the **Top 3** most resonant celebrities from the **corresponding database only**. The percentage mix should reflect the resonance (e.g., 50/30/20).
3.2. Frame the third match as a "wildcard," "spice," or "underlying" element to make the choice feel intentional.
3.3. Synthesize a catchy identity for the user in the detected language.

**[STEP 4: GENERATE JSON OUTPUT]**
4.1. Populate the final output **strictly** following the lean \`OUTPUT_JSON_STRUCTURE\`. This structure is designed to be token-efficient by omitting static wrapper text.
...
\`\`\`json
{
  "shareCard": { "title": "string", "mix": [ { "name": "string", "percentage": "integer", "trait": "string" }, { "name": "string", "percentage": "integer", "trait": "string" }, { "name": "string", "percentage": "integer", "trait": "string" } ], "identity": "string", "callToAction": "string" },
  "deepDive": { "points": [ { "title": "string", "body": "string" } ], "summary": "string" },
  "soulFormula": { "tagline": "string", "matches": [ { "name": "string", "percentage": "integer", "role": "string", "explanation": "string" }, { "name": "string", "percentage": "integer", "role": "string", "explanation": "string" }, { "name": "string", "percentage": "integer", "role": "string", "explanation": "string" } ], "finalIdentity": { "identity": "string", "identity_en": "string" } }
}
\`\`\`
