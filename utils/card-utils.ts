// 生成唯一的卡片ID
export function generateCardId(data: { name: string; analysis: string }): string {
...
// 生成Twitter分享链接
export function generateTwitterShareUrl(data: { name: string; analysis: string; id?: string }, url: string): string {
  // 创建个性化的分享文本
