      ...
      <div className="relative p-4 sm:p-6 lg:p-8">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-6">
          <div className="flex items-center space-x-3">
            <div className="relative flex-shrink-0">
              <Image
                ...
                width={40}
                height={40}
                className="sm:w-12 sm:h-12 rounded-full border-2 border-white shadow-lg ring-2 ring-indigo-200"
              />
            </div>
          ...
          <div className="flex items-center justify-between sm:justify-end gap-3">
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg flex-shrink-0">
                <svg
              ...
              <div className="min-w-0">
                <h2 className="text-lg sm:text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent truncate">
                  {data.cardTitle}
                </h2>
              </div>
            </div>
            ...
            <div className="flex space-x-2 flex-shrink-0">
              <a
                target="_blank"
                className="inline-flex items-center px-2 sm:px-4 py-2 text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg sm:rounded-xl shadow-lg hover:from-indigo-600 hover:to-purple-600 transition-all duration-200 transform hover:scale-105"
        ...
        <div className="mb-6">
          <div className="bg-white/50 rounded-xl p-4 sm:p-5 border border-indigo-100">
            <h3 className="text-base sm:text-lg font-semibold text-indigo-800 mb-3 sm:mb-4">关键洞察</h3>
              ...
              {data.points.map((point, index) => (
                <div key={index} className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-semibold text-gray-900 text-sm sm:text-base mb-1">{point.title}</h4>
                    <p className="text-gray-700 text-sm sm:text-base leading-relaxed">{point.body}</p>
                  </div>
                </div>
              ))}
            </div>
